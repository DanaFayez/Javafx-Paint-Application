...
public class ShapeFactory {
    ...
    // دالة جديدة للـ Bridge pattern
    public Shape createShape(String type, Point2D start, Point2D end, ColorAPI colorAPI) {
        ...
        Color strokeColor = colorAPI.getColor();
        ...
        s.setProperties(m);
        s.setColorAPI(colorAPI);
        
        if (!"Line".equalsIgnoreCase(type)) {
            s.setFillColorAPI(new SolidColor(Color.TRANSPARENT));
        }
